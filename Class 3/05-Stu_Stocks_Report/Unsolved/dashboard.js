var apiKey = "KWjK5LVF4AcLGYD5YBAc";
...
//  This function to unpack arrays within key-value pairs of API response
...
function buildTable(dates, openPrices, highPrices, lowPrices, closingPrices, volume) {
  ...
  //  Create 12 rows in the tbody, and add all unpacked values
  for (var i = 0; i < 12; i++) {
...
function buildPlot() {
  ...
  d3.json(url).then(function(data) {
    ...
    // Access key-value pairs of API response
